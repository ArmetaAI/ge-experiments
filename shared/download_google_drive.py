...
def authenticate_google_drive(credentials_file: str = 'client_secret_441718770100-pqm4o7ut12uis2qov2c15j4q564n7mp7.apps.googleusercontent.com.json'):
    """
...
def download_pdfs_skip_root(
    ...
    credentials_file: str = 'client_secret_441718770100-pqm4o7ut12uis2qov2c15j4q564n7mp7.apps.googleusercontent.com.json'
) -> Dict[str, int]:
    """
...
if __name__ == "__main__":
    # Configuration
    FOLDER_URL = "https://drive.google.com/drive/folders/1WMs_db4IFZKqGiFHTxDj8BBK-5Y0GyKx"

    logger.info("=" * 60)
    logger.info("Starting Google Drive PDF download")
    logger.info(f"Folder URL: {FOLDER_URL}")
    logger.info("Root folder will be ignored - only subfolders processed")
    logger.info("=" * 60)

    stats = download_pdfs_skip_root(
